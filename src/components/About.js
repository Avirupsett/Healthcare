...
export default function About() {
    return (
        <section className='d-flex align-items-center'  style={{ minHeight: "120vh",backgroundColor:"#fff"}}>
            ...
            <div className="row  mb-5 flex-lg-row-reverse align-items-center about">
                ...
                <div className="col-xl-6 col-lg-7 gx-md-1 mb-4 mb-md-0 ">
                    ...
                    <p className='pa-1' style={{color:"#647589",fontSize:"18px",fontFamily:"Calibre R",marginTop:"10px"}}>
