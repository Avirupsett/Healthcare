	...
	c0.4,0.6,0.4,1.3,0.1,1.5l-4.2,2.2C442.3,207.7,441.6,207.4,441.2,206.8z"/>
		...
		C95.6,437.6,95.6,438.8,94.4,439.5z"/>
                    ...
                    <div className="col-xl-6 col-lg-7 gx-md-1 mb-4 mb-md-0 head" style={{ paddingTop: "25px" }}>
                        ...
                        >
                            <Link to="/form/details"><button type="button" className="bg btn rounded-9  btn_hover b_size" data-mdb-ripple-color="var(--first-color)" style={{ background: "var(--first-color) var(--mdb-gradient)", borderColor: "var(--first-color)", padding: "16px 22px", fontSize: "15px", color: '#FFF', fontFamily: 'SF Mono' }}>Get Started</button></Link>
